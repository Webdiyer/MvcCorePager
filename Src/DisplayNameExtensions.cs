...
{
    ///<include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/Classes/Class[@name="DisplayNameExtensions"]/*'/>
    public static class DisplayNameExtensions
    {
        ///<include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/DisplayNameExtensions/Method[@name="DisplayNameFor"]/*'/>
