...
{
    ///<include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/Classes/Class[@name="PagerOptions"]/*'/>
    public class PagerOptions
    {
        ///<include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Constructor[@name="PagerOptions"]/*'/>
        public PagerOptions()
        {
            AutoHide = true;
        ...
        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="Action"]/*'/>
        public string Action { get; set; }

        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="Controller"]/*'/>
        public string Controller { get; set; }


        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="Area"]/*'/>
        public string Area { get; set; }

        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="Route"]/*'/>
        public string Route { get; set; }

        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="OverwriteUrlFormat"]/*'/>
        ...
        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="HtmlAttributes"]/*'/>
        ...
        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="PageIndexBoxId"]/*'/>
        public string PageIndexBoxId { get; set; }

        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="GoToButtonId"]/*'/>
        public string GoToButtonId { get; set; }

        /// <include file='MvcCorePagerDocs.xml' path='MvcCorePagerDocs/PagerOptions/Property[@name="MaximumPageIndexItems"]/*'/>
